...
THe plot below show the time series plot of the data generated from an AR(1) model with theta = 0.6 and sigma squared = 1.
...
autoplot(y) +
  ggtitle("Time Series Plot when theta = 0.6, sigma square = 1") +
    theme_bw()
```

THe plot below show the time series plot of the data generated from an AR(1) model with theta = 0 and sigma squared = 1. By changing the theta, it appears that the seasonal effect got more closer.
...
autoplot(y) +
  ggtitle("Time Series Plot when theta = 0, sigma square = 1") +
  theme_bw()
```
...
autoplot(y) +
  ggtitle("Time Series Plot of MA(1) when theta = 0.6, sigma square = 1") +
  theme_bw()
```
